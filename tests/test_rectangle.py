...
class RectangleTestCase(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(a.top_left.x, 0)
        self.assertEqual(a.top_left.y, 0)
        self.assertEqual(a.bottom_right.x, 10)
        self.assertEqual(a.bottom_right.y, 10)

    def test_init_from_centroid(self):
        a = Rectangle.from_centroid((0, 0), 10, 10)
        self.assertEqual(a.top_left.x, -5)
        self.assertEqual(a.top_left.y, -5)
        self.assertEqual(a.bottom_right.x, 5)
        self.assertEqual(a.bottom_right.y, 5)
